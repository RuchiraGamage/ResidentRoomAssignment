...
public interface FacilityController extends BaseController<Facility> {
    ...
    @PostMapping(value = "{facilityId}/add/{userId}/room/{roomId}")
    ResponseEntity<ApiResponse> addRoomToFacility(@PathVariable(value = "facilityId") Long facilityId, @PathVariable(value = "userId") Long adminId, @PathVariable(value = "roomId") Long roomId);
}
